...
CMakeFiles/stereo_kitti.dir/Examples/Stereo/stereo_kitti.cc.o: Examples/Stereo/stereo_kitti.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/vision/project/test_orb/ORB_SLAM2/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/stereo_kitti.dir/Examples/Stereo/stereo_kitti.cc.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/stereo_kitti.dir/Examples/Stereo/stereo_kitti.cc.o -c /home/vision/project/test_orb/ORB_SLAM2/Examples/Stereo/stereo_kitti.cc
...
CMakeFiles/stereo_kitti.dir/Examples/Stereo/stereo_kitti.cc.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/vision/project/test_orb/ORB_SLAM2/Examples/Stereo/stereo_kitti.cc > CMakeFiles/stereo_kitti.dir/Examples/Stereo/stereo_kitti.cc.i
...
CMakeFiles/stereo_kitti.dir/Examples/Stereo/stereo_kitti.cc.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/vision/project/test_orb/ORB_SLAM2/Examples/Stereo/stereo_kitti.cc -o CMakeFiles/stereo_kitti.dir/Examples/Stereo/stereo_kitti.cc.s
...
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_aruco.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_bgsegm.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_bioinspired.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_ccalib.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_dpm.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_freetype.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_fuzzy.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_line_descriptor.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_optflow.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_reg.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_saliency.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_stereo.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_structured_light.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_phase_unwrapping.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_rgbd.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_surface_matching.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_tracking.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_datasets.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_dnn.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_face.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_plot.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_text.so.3.2.0
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_xfeatures2d.so.3.2.0
...
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_ximgproc.so.3.2.0
...
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_xobjdetect.so.3.2.0
...
Examples/Stereo/stereo_kitti: /usr/local/lib/libopencv_xphoto.so.3.2.0
...
Examples/Stereo/stereo_kitti: CMakeFiles/stereo_kitti.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/vision/project/test_orb/ORB_SLAM2/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable Examples/Stereo/stereo_kitti"
...
CMakeFiles/stereo_kitti.dir/depend:
	cd /home/vision/project/test_orb/ORB_SLAM2 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/vision/project/test_orb/ORB_SLAM2 /home/vision/project/test_orb/ORB_SLAM2 /home/vision/project/test_orb/ORB_SLAM2 /home/vision/project/test_orb/ORB_SLAM2 /home/vision/project/test_orb/ORB_SLAM2/CMakeFiles/stereo_kitti.dir/DependInfo.cmake --color=$(COLOR)
